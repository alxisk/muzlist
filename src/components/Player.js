...
import DEFAULT_CLASS_NAMES
  from 'react-input-range/src/js/input-range/default-class-names.js';
...
class Player extends Component {
  ...
  setVolume() {
    ...
    console.log('audio.volume:', this.audio)
  }
